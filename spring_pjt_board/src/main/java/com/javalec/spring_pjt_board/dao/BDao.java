...
public class BDao {
	...
	public BDto contentView(String strID) {
		...
		return template.queryForObject(query, new BeanPropertyRowMapper<BDto>(BDto.class));// contentview깐 데이터를 가져오는거니깐
																							// forobject
	}
	...
	public BDto reply_view(String str) {
		...
		// ParameterizedBeanPropertyRowMapper.newInstance(BDto.class));
